...
// Komen op een loginpagina, Wanneer de knop ingedrukt wordt, wordt er gekeken of deze aanwezig is of niet
if (isset($_POST['submit'])){
    ...
    //Als er een login gevonden is, dan gaan we inloggen met die user en gaan we naar index.php. Zoniet message tonen.
    if ($user_found){
