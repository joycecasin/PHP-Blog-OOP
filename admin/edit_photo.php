            ...
            <form action="edit_photo.php?id=<?php echo $photo->id; ?>" method="post">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="<?php echo $photo->tittle; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="photo-info-box">
                        ...
                        <div class="inside">
                            <div class="box-inner">
                                ...
                                <p class="text">
                                    Photo id: <span class="data photo_id_box">Uploaded on: April, 15, 2019 @ 7:54</span>
                                </p>
                                <p class="text">
